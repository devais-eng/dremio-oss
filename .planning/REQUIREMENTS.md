...
- [x] **UI-06**: Non-admin users cannot access the space settings gear icon without space management permissions (Issue #11)
...
| LOGIC-01 | Phase 25, 29 | Complete |
| LOGIC-02 | Phase 25, 29 | Complete |
